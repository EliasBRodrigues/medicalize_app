...
import { Modal, View, NativeScrollEvent, NativeSyntheticEvent, } from "react-native";
...
type Props = ModalProps & SearchBarProps & {
    data: Item[];
};


export function SerachModal({visible, onClose, value, onChangeText, data  }: Props) {
